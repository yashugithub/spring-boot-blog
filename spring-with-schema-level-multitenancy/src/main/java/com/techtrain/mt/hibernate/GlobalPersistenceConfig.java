...
@EnableJpaRepositories(
        basePackages = {"${multitenancy.parent.repository.packages}"},
...
public class GlobalPersistenceConfig {
    ...
    @Autowired
    public GlobalPersistenceConfig(ConfigurableListableBeanFactory beanFactory,
                                   JpaProperties jpaProperties,
                                   @Value("${multitenancy.parent.entityManager.packages}")
